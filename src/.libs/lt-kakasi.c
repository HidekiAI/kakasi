...
/* ./.libs/lt-kakasi.c - temporary wrapper executable for .libs/kakasi.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.1

   The kakasi program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "kakasi.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# kakasi - temporary wrapper script for .libs/kakasi.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.1\n", f);
  fputs ("#\n", f);
  fputs ("# The kakasi program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"kakasi.exe:kakasi:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debi", f);
  fputs ("an-2.4.2-1.1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"kakasi.exe:kakasi:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"kakasi.exe:kakasi:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
