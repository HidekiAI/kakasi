...
/* ./.libs/lt-wx2_conv.c - temporary wrapper executable for .libs/wx2_conv.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.1

   The wx2_conv program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "C:\\msys64\\clang64\\lib;C:\\msys64\\clang64\\bin;";
const char * TARGET_PROGRAM_NAME = "wx2_conv.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# wx2_conv - temporary wrapper script for .libs/wx2_conv.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.1\n", f);
  fputs ("#\n", f);
  fputs ("# The wx2_conv program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"wx2_conv.exe:wx2_conv:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 ", f);
  fputs ("Debian-2.4.2-1.1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"wx2_conv.exe:wx2_conv:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"wx2_conv.exe:wx2_conv:${LINENO}: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
  ...
  fputs ("    PATH=/clang64/lib:/clang64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
